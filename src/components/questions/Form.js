...
export default function Form() {
    ...
    const saveQuestion = () => {
        ...
        createQuestion({
            title: question,
            questionType: validOptions ? "multiple" : "abierta",
            questionOptions: []
        })
    }
    ...
    return <Container maxWidth="sm">
        <Paper elevation={3} sx={{ marginTop: 5 }} >
            <CardContent sx={{ display: "flex", flexDirection: "row", justifyContent: "center", alignItems: "center" }} >
                ...
                />
                <Button size="small" variant="contained" color="success" onClick={saveQuestion}>Guardar</Button>
            </CardContent>
            <p>Falta la logica para agregar la multiple</p>
